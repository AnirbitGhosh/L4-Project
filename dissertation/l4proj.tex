...
\begin{itemize}
    \item Section WSI into 96x96px tiles at 10x objective resolution
    ...
    \item Query fitted survival model to generate KM plots for each covariate 
    \item Compute the average median survival time from each KM plot
\end{itemize}
